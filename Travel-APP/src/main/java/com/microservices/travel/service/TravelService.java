package com.microservices.travel.service;

import com.microservices.travel.dto.HotelSearchDTO;
import com.microservices.travel.dto.HotelSearchSuggestionDTO;
import com.microservices.travel.repository.HotelRequest;
import com.microservices.travel.repository.HotelRequestRepository;
import com.microservices.travel.repository.HotelSuggestion;
import com.microservices.travel.repository.HotelSuggestionEntity;
...
public class TravelService {
    ...
    @HystrixCommand(fallbackMethod = "defaultStores", commandKey = "defaultStores")
    public HotelSearchDTO searchRequest(String query) throws Exception {
    ...
    public HotelSearchDTO defaultStores(String query) throws Exception {
