...
import com.movieApp.controller.IMBDResponseDTO;
import com.movieApp.event.RabbitSearchEvent;
import com.movieApp.event.RabbitSearchEventDispatcher;
import com.movieApp.persistence.*;
...
public class IMDBApiService {
    ...
    private RabbitSearchEventDispatcher rabbitSearchEventDispatcher;
    ...
    public IMBDResponseDTO searchRequest(String content) {
        ...
        rabbitSearchEventDispatcher.send(new RabbitSearchEvent(UUID.randomUUID().toString(), content, "MovieApp"));
    ...
    @Autowired
    public void setRabbitSearchEventDispatcher(RabbitSearchEventDispatcher rabbitSearchEventDispatcher) {
        this.rabbitSearchEventDispatcher = rabbitSearchEventDispatcher;
    }
